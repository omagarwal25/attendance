...
var _a = require("@prisma/client"), PrismaClient = _a.PrismaClient, BuildSession = _a.BuildSession;
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    user = _a.sent();
                    return [4 /*yield*/, prisma.buildSession.deleteMany({
                            where: {
                                userId: user.id
                            }
                        })];
...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _i = 0, _a = toDelete.split("\n");
                    _b.label = 1;
                case 1:
                    if (!(_i < _a.length)) return [3 /*break*/, 4];
                    email = _a[_i];
                    return [4 /*yield*/, deleteUser(email)];
                case 2:
                    _b.sent();
                    _b.label = 3;
                case 3:
